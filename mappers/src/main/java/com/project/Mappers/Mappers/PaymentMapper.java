...
public interface PaymentMapper {
    ...
    @Mapping(source = "amount", target = "paymentReqDetails.amount", defaultValue = "")
    @Mapping(source = "companyCode", target = "paymentReqDetails.companyCode", defaultValue = "")
    ...
    @Mapping(source = "invoices", target = "invoices")
    PayloadEntity toPayloadEntity(PaymentInternalDTO payloadInternalDTO);
}
